...
uint32_t php_sandbox_monitor_wait(php_sandbox_monitor_t *m, uint32_t state, zend_bool lock);
void php_sandbox_monitor_set(php_sandbox_monitor_t *m, uint32_t state, zend_bool lock);
void php_sandbox_monitor_unset(php_sandbox_monitor_t *m, uint32_t state, zend_bool lock);
